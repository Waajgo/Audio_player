...
import { renderTrackItem } from './src/view/components/trackView';
import { TrackListType, TrackType } from './src/types/types';
...
const mokTrackCard: HTMLElement = renderTrackItem(mokTrack);

document.addEventListener('DOMContentLoaded', () => {
  mount(document.body, mokTrackCard);
})
